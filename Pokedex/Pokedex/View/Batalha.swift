...
struct Batalha: View {
    ...
    @State var emataque: Bool = false
    @State var estadobatalha: BatalhaEstado = BatalhaEstado.ongoing
        ...
        ZStack {
            ...
            if estadobatalha == .playerLost {
                Button(action: {
                    ...
                    Text("Perdeu. Clique para voltar para a Pokedex.")
                ...
                Button(action: {
                    ...
                    Text("Ganhou. Clique para voltar para a Pokedex.")
                        .foregroundColor(.primary)
                        .font(.title)
                        .fontWeight(.bold)
                }
